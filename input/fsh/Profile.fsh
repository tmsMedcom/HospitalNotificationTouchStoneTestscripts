...
* profile.reference = "http://medcomfhir.dk/fhir/messaging/StructureDefinition/medcom-messaging-provenance" 

RuleSet: profileMessagingOrganization
* profile.id = "messaging" //TODO change name
* profile.reference = "http://medcomfhir.dk/fhir/messaging/StructureDefinition/medcom-messaging-organization" 

RuleSet: profileCorePatient
* profile.id = "core" //TODO change name
* profile.reference = "https://build.fhir.org/ig/medcomdk/dk-medcom-core/StructureDefinition-medcom-core-patient.html"

RuleSet: profileCoreOrganization
* profile.id = "core" //TODO change name
* profile.reference = "http://medcomfhir.dk/fhir/dk-medcom-core/StructureDefinition/medcom-core-organization"
 */
