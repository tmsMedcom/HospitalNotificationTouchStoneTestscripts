//STIN+SLHJ+STIN
Alias: $Fixture9STINRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-STIN-UF_H_V_09.xml
Alias: $Fixture9STIN = bundle-create-STIN


Alias: $Fixture9SLHJRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-SLHJ-UF_H_V_09.xml
Alias: $Fixture9SLHJID = bundle-create-SLHJ

Alias: $Fixture9STIN2Refference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-STIN2-UF_H_V_09.xml
Alias: $Fixture9STIN2ID = bundle-create-STIN2


Instance: TestinstanceUFHV9
...
* fixture[0].id = $Fixture9STIN
* fixture[0].autocreate = false
* fixture[0].autodelete = false
* fixture[0].resource.reference = $Fixture9STINRefference

* fixture[2].id = $Fixture9SLHJID
* fixture[2].autocreate = false
* fixture[2].autodelete = false
* fixture[2].resource.reference = $Fixture9SLHJRefference

* fixture[1].id = $Fixture9STIN2ID
* fixture[1].autocreate = false
* fixture[1].autodelete = false
* fixture[1].resource.reference = $Fixture9STIN2Refference
...
* setup.action[1].operation.sourceId = $Fixture9STIN
...
* setup.action[8].operation.sourceId = $Fixture9SLHJID
...
* setup.action[4].operation.sourceId = $Fixture9STIN2ID
