//STIN+SLHJ+STIN
Alias: $Fixture11STINRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-STIN-UF_H_V_11.xml
Alias: $Fixture11STIN = bundle-create-STIN


Alias: $Fixture11SLHJRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-SLHJ-UF_H_V_11.xml
Alias: $Fixture11SLHJID = bundle-create-SLHJ

Alias: $Fixture11STIN2Refference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-STIN2-UF_H_V_11.xml
Alias: $Fixture11STIN2ID = bundle-create-STIN2


Instance: TestinstanceUFHV11
...
* fixture[0].id = $Fixture11STIN
* fixture[0].autocreate = false
* fixture[0].autodelete = false
* fixture[0].resource.reference = $Fixture11STINRefference

* fixture[2].id = $Fixture11SLHJID
* fixture[2].autocreate = false
* fixture[2].autodelete = false
* fixture[2].resource.reference = $Fixture11SLHJRefference

* fixture[1].id = $Fixture11STIN2ID
* fixture[1].autocreate = false
* fixture[1].autodelete = false
* fixture[1].resource.reference = $Fixture11STIN2Refference
...
* setup.action[1].operation.sourceId = $Fixture11STIN
...
* setup.action[7].operation.params = "?message.destination-uri=${destinationUriSLHJ9}"
...
* setup.action[8].operation.sourceId = $Fixture11SLHJID
...
* setup.action[4].operation.sourceId = $Fixture11STIN2ID
...
* test[1].id = "02-SLHJ-leave"
* test[1].name = "HospitalNotification-SLHJ-leave"
...
* test[1].action[0].operation.params = "?message.destination-uri=${destinationUriSLHJ9}"
...
* test[2].id = "03-STIN"
* test[2].name = "HospitalNotification-STIN2-admit"
...
* test[2].action[0].operation.description = "The patient does not show up after ended leave -STIN"
...
* test[2].action[0].operation.params = "?message.destination-uri=${destinationUriSTIN2}"
