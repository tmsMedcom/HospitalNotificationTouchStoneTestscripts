RuleSet: createInitialMessageDynamic(type, number, fixture, activityCode, encounterClass, encounterStatus, reportOfAdmission)
...
*/
* insert dynamicFixture({fixture}, {type}, {number})
