//STIN+STOR+SLHJ
Alias: $Fixture15STINRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/send/Userstory/_reference/resources/HospitalNotificationMessage-STIN-UF_H_V_20.xml
Alias: $Fixture15STIN = bundle-create-STIN

Alias: $Fixture15STORRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/send/Userstory/_reference/resources/HospitalNotificationMessage-STOR-UF_H_V_20.xml
Alias: $Fixture15STORID = bundle-create-STOR

Alias: $Fixture15MORSRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/send/Userstory/_reference/resources/HospitalNotificationMessage-MORS-UF_H_V_20.xml
Alias: $Fixture15MORSID = bundle-create-MORS
...
* fixture[0].id = $Fixture15STIN
* fixture[0].autocreate = false
* fixture[0].autodelete = false
* fixture[0].resource.reference = $Fixture15STINRefference

* fixture[1].id = $Fixture15STORID
* fixture[1].autocreate = false
* fixture[1].autodelete = false
* fixture[1].resource.reference = $Fixture15STORRefference

* fixture[2].id = $Fixture15MORSID
* fixture[2].autocreate = false
* fixture[2].autodelete = false
* fixture[2].resource.reference = $Fixture15MORSRefference
...
* variable[0].sourceId = $Fixture15STIN

* variable[1].name = "destinationUriSTOR15"
* variable[1].expression = "Bundle.entry.resource.ofType(MessageHeader).destination.endpoint"
* variable[1].sourceId = $Fixture15STORID

* variable[2].name = "destinationUriMORS15"
* variable[2].expression = "Bundle.entry.resource.ofType(MessageHeader).destination.endpoint"
* variable[2].sourceId = $Fixture15MORSID
...
* setup.action[1].operation.sourceId = $Fixture15STIN
...
* setup.action[3].operation.params = "?message.destination-uri=${destinationUriSTOR15}"
...
* setup.action[4].operation.sourceId = $Fixture15STORID
...
* setup.action[7].operation.params = "?message.destination-uri=${destinationUriMORS15}"
...
* setup.action[8].operation.sourceId = $Fixture15MORSID
