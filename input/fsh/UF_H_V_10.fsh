//STIN+STIN+SLHJ
Alias: $Fixture10STIN1Refference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/STIN-UF_H_V_10.xml
Alias: $Fixture10STIN1 = bundle-create-STIN1

Alias: $$Fixture10STIN2Refference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/STIN2-UF_H_V_10.xml
Alias: $Fixture10STIN2ID = bundle-create-STIN2

Alias: $Fixture10SLHJRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/SLHJ-UF_H_V_10.xml
Alias: $Fixture10SLHJID = bundle-create-SLHJ
...
* fixture[0].id = $Fixture10STIN1
* fixture[0].autocreate = false
* fixture[0].autodelete = false
* fixture[0].resource.reference = $Fixture10STIN1Refference

* fixture[1].id = $Fixture10STIN2ID
* fixture[1].autocreate = false
* fixture[1].autodelete = false
* fixture[1].resource.reference = $$Fixture10STIN2Refference

* fixture[2].id = $Fixture10SLHJID
* fixture[2].autocreate = false
* fixture[2].autodelete = false
* fixture[2].resource.reference = $Fixture10SLHJRefference
...
* setup.action[1].operation.sourceId = $Fixture10STIN1
...
* setup.action[4].operation.sourceId = $Fixture10STIN2ID
...
* setup.action[8].operation.sourceId = $Fixture10SLHJID
