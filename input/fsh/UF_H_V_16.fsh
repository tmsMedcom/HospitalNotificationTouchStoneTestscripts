//STIN
Alias: $Fixture16STINRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/STIN_16.xml
Alias: $Fixture16STIN = bundle-create-STIN
...
* fixture[0].id = $Fixture16STIN
* fixture[0].autocreate = false
* fixture[0].autodelete = false
* fixture[0].resource.reference = $Fixture16STINRefference
...
* variable[0].sourceId = $Fixture16STIN
...
* setup.action[1].operation.sourceId = $Fixture16STIN
