...
* fixture[=].resource.reference = "/FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-STIN-UF_H_V_09.xml"

* fixture[+].id = "bundle-create-SLHJ"
* fixture[=].autocreate = false
* fixture[=].autodelete = false
* fixture[=].resource.reference = "/FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-SLHJ-UF_H_V_09.xml"

* fixture[+].id = "bundle-create-STIN2"
* fixture[=].autocreate = false
* fixture[=].autodelete = false
* fixture[=].resource.reference = "/FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-STIN2-UF_H_V_09.xml"
...
* insert createAckTest(5, bundle-create-STIN2, bundleResourceid2, MessageHeaderIdentifier2, ProvenanceID2)
