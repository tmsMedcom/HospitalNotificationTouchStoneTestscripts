//STIN+STOR+SLHJ
Alias: $Fixture6STINRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-STIN-UF_H_V_06.xml
Alias: $Fixture6STIN = bundle-create-STIN

Alias: $Fixture6STORRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-STOR-UF_H_V_06.xml
Alias: $Fixture6STORID = bundle-create-STOR

Alias: $Fixture6SLHJRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/HospitalNotificationMessage-SLHJ-UF_H_V_06.xml
Alias: $Fixture6SLHJID = bundle-create-AN-SLHJ
...
* fixture[0].id = $Fixture6STIN
* fixture[0].autocreate = false
* fixture[0].autodelete = false
* fixture[0].resource.reference = $Fixture6STINRefference

* fixture[1].id = $Fixture6STORID
* fixture[1].autocreate = false
* fixture[1].autodelete = false
* fixture[1].resource.reference = $Fixture6STORRefference

* fixture[2].id = $Fixture6SLHJID
* fixture[2].autocreate = false
* fixture[2].autodelete = false
* fixture[2].resource.reference = $Fixture6SLHJRefference
...
* variable[0].sourceId = $Fixture6STIN

* variable[1].name = "destinationUriSTOR6"
* variable[1].expression = "Bundle.entry.resource.ofType(MessageHeader).destination.endpoint"
* variable[1].sourceId = $Fixture6STORID

* variable[2].name = "destinationUriSLHJ6"
* variable[2].expression = "Bundle.entry.resource.ofType(MessageHeader).destination.endpoint"
* variable[2].sourceId = $Fixture6SLHJID
...
* setup.action[1].operation.sourceId = $Fixture6STIN
...
* setup.action[3].operation.params = "?message.destination-uri=${destinationUriSTOR6}"
...
* setup.action[4].operation.sourceId = $Fixture6STORID
...
* setup.action[7].operation.params = "?message.destination-uri=${destinationUriSLHJ6}"
...
* setup.action[8].operation.sourceId = $Fixture6SLHJID
...
* test[1].action[0].operation.params = "?message.destination-uri=${destinationUriSTOR6}"
...
* test[2].action[0].operation.params = "?message.destination-uri=${destinationUriSLHJ6}"
