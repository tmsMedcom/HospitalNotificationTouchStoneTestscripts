Alias: $Fixture1STINRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/STIN_14.xml
Alias: $Fixture1STIN = bundle-create-STIN

Alias: $Fixture2RESTINRefference = /FHIRSandbox/MedCom/401-Hospitalnotification/receive/Userstory/_reference/resources/RE_STIN_14.xml
Alias: $FixtureRESTINID = bundle-create-RE-STIN

Instance: TestinstanceUFHV2
...
* fixture[0].resource.reference = $Fixture1STINRefference

* fixture[1].id = $FixtureRESTINID
* fixture[1].autocreate = false
* fixture[1].autodelete = false
* fixture[1].resource.reference = $Fixture2RESTINRefference
...
* setup.action[3].operation.params = "?message.destination-uri=${destinationUriREK1}"
...
* setup.action[4].operation.sourceId = $FixtureRESTINID
...
* test[1].action[0].operation.params = "?message.destination-uri=${destinationUriREK1}"
